...
export function GET() {
  ...
  <!-- Subtitle -->
  <text x="600" y="280" text-anchor="middle" font-family="Inter, system-ui, sans-serif" font-size="26" fill="${c.texte_secondaire}">Compte à rebours en direct</text>
  ...
  <text x="600" y="450" text-anchor="middle" font-family="Inter, system-ui, sans-serif" font-size="20" fill="${c.texte_secondaire}">événement${upcomingCount > 1 ? 's' : ''} à venir</text>
